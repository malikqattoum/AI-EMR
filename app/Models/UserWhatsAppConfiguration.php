...
class UserWhatsAppConfiguration extends Model
{
    protected $fillable = [
        'user_id',
        'hospital_id',
    ...
    /**
     * Get active WhatsApp configurations for a specific user
     */
    ...
    /**
     * Get active WhatsApp configurations for a specific hospital
     */
    ...
    public function getSanitizedConfig(): array
    {
        ...
        $sensitiveFields = ['auth_token', 'password', 'access_key', 'secret', 'key', 'api_key', 'account_sid', 'auth_token', 'whatsapp_number', 'from'];
