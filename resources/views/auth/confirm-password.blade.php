...
@section('title', 'Confirm Password — MedSuite AI')
...
<div class="msdr-root">
    ...
    <aside class="msdr-panel">
        ...
        <div class="msdr-panel-inner">
            ...
            <ul class="msdr-panel-features">
                ...
                <li>
                    <div class="msdr-pf-icon"><i class="bi bi-fingerprint"></i></div>
                    <div>
                        <strong>Secure Sessions</strong>
                        <span>Your session is fully encrypted</span>
                    </div>
                </li>
                <li>
    ...
    <main class="msdr-form-panel">
        ...
        <div class="msdr-form-topbar">
            <a href="{{ url()->previous() }}" class="msdr-back-btn">
                <i class="bi bi-arrow-left"></i> Back
            </a>
            <span class="msdr-topbar-hint">Need help?</span>
            <a href="{{ route('login') }}" class="msdr-topbar-link">Contact Support <i class="bi bi-arrow-right ms-1"></i></a>
        </div>

        <div class="msdr-form-wrapper">
            <div class="msdr-form-header">
                <h1>Confirm<br><em>password.</em></h1>
                <p>Please confirm your password to access this secure area.</p>
            </div>

            <form method="POST" action="{{ route('password.confirm') }}" class="msdr-form" novalidate>
                @csrf
                ...
                <div class="msdr-field">
                    ...
                    <div class="msdr-input-wrap msdr-input-wrap-toggle">
                        ...
                        >
                        <button type="button" class="msdr-eye-btn" onclick="msdrToggle('password', 'eye-password')">
                            <i id="eye-password" class="bi bi-eye"></i>
                        </button>
                    </div>
                    @error('password')
