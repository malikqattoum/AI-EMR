...
@section('title', 'Patient Registration — MedSuite AI')
    ...
    <aside class="msdr-panel">
        ...
        <div class="msdr-panel-inner">
            ...
            <div class="msdr-panel-headline">
                <h2>Your health,<br>your way,<br><em>simplified.</em></h2>
                <p>Join MedSuite's patient portal for seamless healthcare management with AI-powered assistance.</p>
            </div>

            <!-- Features list -->
            <ul class="msdr-panel-features">
                <li>
                    <div class="msdr-pf-icon"><i class="bi bi-calendar-check"></i></div>
                    <div>
                        <strong>Easy Appointment Booking</strong>
                        <span>Schedule visits with just a few taps</span>
                    </div>
                </li>
                <li>
                    <div class="msdr-pf-icon"><i class="bi bi-file-earmark-medical"></i></div>
                    <div>
                        <strong>Secure Health Records</strong>
                        <span>Access your history anytime, anywhere</span>
                    </div>
                </li>
                <li>
                    <div class="msdr-pf-icon"><i class="bi bi-clock-history"></i></div>
                    <div>
                        <strong>Appointment History</strong>
                        <span>Never miss a detail of your care</span>
                    </div>
                </li>
                <li>
                    <div class="msdr-pf-icon"><i class="bi bi-bell"></i></div>
                    <div>
                        <strong>Email Reminders</strong>
                        <span>Stay on top of your health journey</span>
                    </div>
                </li>
            </ul>
            ...
            <div class="msdr-panel-trust">
                ...
                <div class="msdr-trust-row">
                    ...
                    <span>Trusted by 10,000+ patients nationwide</span>
                </div>
            </div>
        </div>
    </aside>
    ...
    <main class="msdr-form-panel">
        ...
        <div class="msdr-form-wrapper">
            ...
            <div class="msdr-progress">
                ...
                <span class="msdr-progress-label">Patient Registration</span>
            </div>

            <div class="msdr-form-header">
                <h1>Create your<br><em>patient account.</em></h1>
                <p>Fill in your details to get started. It only takes 2 minutes.</p>
            </div>

            <!-- FORM -->
            <form method="POST" action="{{ route('patient.register.store') }}" class="msdr-form" novalidate>
                @csrf
                ...
                <div class="msdr-field">
                    ...
                    <div class="msdr-field-hint">
                        <i class="bi bi-info-circle"></i> Used for appointment reminders. Include country code.
                    </div>
                    @error('phone')
                        <div class="msdr-error-msg"><i class="bi bi-exclamation-circle"></i> {{ $message }}</div>
                    @enderror
                ...
                <div class="msdr-field-row">
                    <!-- Date of Birth -->
                    <div class="msdr-field">
                        <label for="date_of_birth" class="msdr-label">
                            <i class="bi bi-calendar-event"></i> Date of Birth
                        </label>
                        <div class="msdr-input-wrap">
                            <input
                                id="date_of_birth" type="date" name="date_of_birth"
                                class="msdr-input @error('date_of_birth') msdr-input-error @enderror"
                    ...
                    <!-- Gender -->
                    <div class="msdr-field">
                        <label for="gender" class="msdr-label">
                            <i class="bi bi-gender-neuter"></i> Gender
                        </label>
                        <div class="msdr-select-wrap">
                            <select
                                id="gender" name="gender"
                                class="msdr-input msdr-select @error('gender') msdr-input-error @enderror"
                                required
                            >
                ...
                <div class="msdr-terms">
                    <input class="msdr-checkbox" type="checkbox" id="terms" name="terms" required>
                    <label for="terms">
